...
public class PartialContentServingTest {
    ...
    public void testGetBytesReturnsPartialOfPassedInServerGetBytes() throws Exception {
        NotFoundServing notFoundServing = new NotFoundServing();
        PartialContentServing server = new PartialContentServing(notFoundServing, 0, 20);
    ...
    public void testGetHTTPCode() throws Exception {
        PartialContentServing server = new PartialContentServing(new DirectoryServing("/", new FilePaths("/")), 0, 20);
    ...
    public void testGetContentTypeReturnsTypeOfServerPassedInTextHTML() throws Exception {
        DirectoryServing directoryServing = new DirectoryServing("/", new FilePaths("/"));
        PartialContentServing server = new PartialContentServing(directoryServing, 0, 20);
    ...
    public void testGetContentTypeReturnsTypeOfServerPassedInImageFile() throws Exception {
        ...
        PartialContentServing server = new PartialContentServing(fileServing, 0, 20);

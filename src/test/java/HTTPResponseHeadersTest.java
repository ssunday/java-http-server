...
public class HTTPResponseHeadersTest {
    ...
    public void testGetHeaderIncludes200CodePassedIn(){
        ...
        String header = HTTPResponseHeaders.getHTTPHeader(200, "text/html", contentLength, methodOptions);
    ...
    public void testGetHeaderIncludes206CodePassedIn(){
        int contentLength = 30;
        String[] methodOptions = new String[]{"GET"};
        String header = HTTPResponseHeaders.getHTTPHeader(206, "text/html", contentLength, methodOptions);
    ...
    public void testGetHeaderIncludes404CodePassedIn(){
        int contentLength = 30;
        String[] methodOptions = new String[]{"GET"};
        String header = HTTPResponseHeaders.getHTTPHeader(404, "text/html", contentLength, methodOptions);
    ...
    public void testGetHeaderIncludes401CodePassedIn(){
        int contentLength = 30;
        String[] methodOptions = new String[]{"GET"};
        String header = HTTPResponseHeaders.getHTTPHeader(401, "text/plain", contentLength, methodOptions);
    ...
    public void testGetHeaderIncludes405CodePassedIn(){
        int contentLength = 30;
        String[] methodOptions = new String[]{"GET"};
        String header = HTTPResponseHeaders.getHTTPHeader(405, "text/plain", contentLength, methodOptions);
    ...
    public void testGetHeaderIncludesTextHtmlContentType(){
        ...
        String[] methodOptions = new String[]{"GET"};
        String header = HTTPResponseHeaders.getHTTPHeader(200, type, contentLength, methodOptions);
